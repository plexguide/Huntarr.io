...
const SettingsForms = {
  ...
  generateSonarrForm: function (container, settings = {}) {
    ...
    console.log('[HUNTARR DEBUG] Custom Tags and Additional Options sections REMOVED - v2026-01-26');
    container.innerHTML =
      ...
      const formFields = `
          ...
          <div class="modal-form-section">
              ...
              <div class="modal-field-group">
                  ...
                  <p class="modal-help-text">The full URL including port (e.g. http://localhost:9696)</p>
              </div>
              ...
              <div class="modal-field-group">
                  ...
                  <p class="modal-help-text">Found in Settings > General in Prowlarr</p>
              </div>
          </div>
      `;
