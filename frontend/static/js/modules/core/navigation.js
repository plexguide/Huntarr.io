...
window.HuntarrNavigation = {
    ...
    switchSection: function(section) {
        ...
        const sectionMap = {
            ...
            'settings-remote-mappings': { title: 'Remote Path Mappings', nav: document.getElementById('movieHuntSettingsRemoteMappingsNav'), section: document.getElementById('settingsRemoteMappingsSection'), sidebar: 'moviehunt' },
        ...
        if (section === 'settings-remote-mappings' && window.RemoteMappings && typeof window.RemoteMappings.refreshList === 'function') {
    ...
    updateMovieHuntSidebarActive: function() {
        ...
        if (subGroup) {
            var showSub = ['movie-hunt-settings', 'settings-movie-management', 'settings-profiles', 'profile-editor', 'settings-custom-formats', 'settings-indexers', 'settings-clients', 'settings-root-folders', 'settings-remote-mappings', 'instance-editor'].indexOf(currentSection) !== -1;
