...
window.HuntarrNavigation = {
    ...
    switchSection: function(section) {
        ...
        const sectionMap = {
            ...
            'movie-hunt-home': { title: 'Movie Collection', nav: document.getElementById('movieHuntCollectionNav'), section: document.getElementById('movie-hunt-section'), sidebar: 'moviehunt', view: 'collection' },
            'movie-hunt-collection': { title: 'Movie Collection', nav: document.getElementById('movieHuntCollectionNav'), section: document.getElementById('movie-hunt-section'), sidebar: 'moviehunt', view: 'collection' },
            ...
            'requestarr-smarthunt-settings': { title: 'Smart Hunt', nav: document.getElementById('requestarrSmartHuntSettingsNav'), section: document.getElementById('requestarr-section'), sidebar: 'requestarr', view: 'smarthunt-settings' },
            ...
            'settings-sizes': { title: 'Sizes', nav: document.getElementById('movieHuntSettingsSizesNav'), section: document.getElementById('settingsSizesSection'), sidebar: 'moviehunt' },
            ...
            'settings-import-lists': { title: 'Import Lists', nav: document.getElementById('movieHuntSettingsImportListsNav'), section: document.getElementById('settingsImportListsSection'), sidebar: 'moviehunt' },
            'settings-import-media': { title: 'Import Media', nav: document.getElementById('movieHuntSettingsImportMediaNav'), section: document.getElementById('settingsImportMediaSection'), sidebar: 'moviehunt' },
        ...
        if (section === 'settings-sizes' && window.SizesModule && typeof window.SizesModule.load === 'function') {
        ...
        if (section === 'settings-import-lists' && window.ImportLists && typeof window.ImportLists.refreshList === 'function') {
            window.ImportLists.refreshList();
        }
        if (section === 'settings-import-media' && window.ImportMedia && typeof window.ImportMedia.init === 'function') {
